...
public class DependenciesAnalyzer {
    ...
    public Set<String> findDependencies(String className, String include) {
    ...
    private void findDependencies(String className, Set<String> dependencies, String classNamePrefix) {
        try {
